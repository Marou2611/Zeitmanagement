...
@section('content')
<h1 class="my-4 h3">Stundenpläne für das Semester: <b>{{ $semester->name }}</b></h1>

@foreach ($timetables as $entity)
<!-- Überschrift für jeden Dozenten -->
<h2 class="mt-5 h4">{{ $entity->lecturer->firstname }} {{ $entity->lecturer->lastname }}</h2>
...
<!-- Button zur Rückkehr -->
<a href="{{ url()->previous() }}" class="btn btn-primary mb-5">Zurück</a>
