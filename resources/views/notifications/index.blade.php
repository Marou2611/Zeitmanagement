...
<div class="container mt-5">
    ...
    @if(!$currentSemester)
        ...
        <div class="alert alert-warning" role="alert">
            <h4 class="alert-heading">Kein Semester vorhanden</h4>
            <p>Es wurde noch kein Semester erstellt. Bitte erstelle zuerst ein Semester.</p>
            <a href="{{ url('/semesters/add') }}" class="btn btn-primary">Semester erstellen</a>
        </div>
    @else
